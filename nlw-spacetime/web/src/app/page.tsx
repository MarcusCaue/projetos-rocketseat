      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url('../assets/bg-stars.svg')] bg-cover px-28 py-16">
        ...
        >
          ...
          <p className="max-w-[160px] text-sm leading-snug">
            <span className="underline">Crie a sua conta</span> e salve as suas
            memórias
          </p>
        </a>
        ...
        <div className="space-y-5">
          ...
          <a
            className="inline-block rounded-full bg-green-500 px-5 py-3 font-alter text-sm font-bold uppercase leading-none text-black hover:bg-green-600"
            href=""
          >
            CADASTRAR LEMBRANÇA
          </a>
